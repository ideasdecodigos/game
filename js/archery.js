...
startSound.src = "../music/hit.mp3";
startSound.volume = 0.6;
        
var shootSound = new Audio();
shootSound.src = "../music/acierto.mp3";
        
var hitSound = new Audio();
hitSound.src = "../music/disparo.mp3";
        
var bgSound = new Audio();
bgSound.src = "../music/ticker.mp3"//"music2.ogg";
bgSound.loop = true;
//bgSound.volume = 0.8;
        
var endSound = new Audio();
endSound.src = "../music/hit.mp3";
endSound.volume = 0.6;
        
var successSound = new Audio();
successSound.src = "../music/click.mp3";
        
var highScoreSound = new Audio();
highScoreSound.src = "../music/cargar.mp3";
